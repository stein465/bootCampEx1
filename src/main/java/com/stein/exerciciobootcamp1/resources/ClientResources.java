package com.stein.exerciciobootcamp1.resources;
...
import com.stein.exerciciobootcamp1.services.ClientService;
...
public class ClientResources {
	...
	public ResponseEntity<Page<ClientDTO>> findAllPaged(@RequestParam(value = "page", defaultValue = "0") Integer page,
		...
		Page<ClientDTO> listDTO = service.findAllPaged(request);
